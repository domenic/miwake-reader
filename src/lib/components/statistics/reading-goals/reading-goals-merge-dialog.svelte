<script module lang="ts">
  import ReadingGoalsMergeDialog from '$lib/components/statistics/reading-goals/reading-goals-merge-dialog.svelte';
  ...
  export function showReadingGoalsMergeDialog(params: {
