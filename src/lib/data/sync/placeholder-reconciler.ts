 ...
 * Companion `lastItem` rows and bookmarks copied from the sync source for placeholders are
 * cascade-cleaned via `database.deleteData`; reading data created for downloaded books is retained.
